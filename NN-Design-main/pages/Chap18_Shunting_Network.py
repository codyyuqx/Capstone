...
def shunt(y, t, pp, pn, bp, bn, e):
   return (-y + (bp - y) * pp - (y + bn) * pn) / e
...
if __name__ == "__main__":
   ...
   with st.sidebar:
      ...
      st.markdown(
         'Use the slide bars to adjust the inputs, biases and the time constant (eps)."\n\n Click [Clear] to remove old responses.'
...
response = odeint(shunt, 0, t, args=(pp, pn, bp, bn, e)).flatten()
