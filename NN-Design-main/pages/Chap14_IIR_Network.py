...
class FIRNetwork():
    def __init__(self, func1, freq, weight_0, weight_1, autoscale):
...
if __name__ == "__main__":
    ...
    app = FIRNetwork(func1, freq, weight_0, weight_1, autoscale)

    st.markdown(load_svg_2(get_image_path("Figures/nnd14_2.svg")), unsafe_allow_html=True)
    #st.image('media/Figures/nnd14_2.svg', width=600)
    st.text('')
