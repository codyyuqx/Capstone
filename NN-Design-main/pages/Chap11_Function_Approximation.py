...
class FunctionApproximation():
    ...
    def on_animate_v2(self, idx):
        ...
        return [self.fixed_frame,
                go.Scatter(x=self.p.reshape(-1), y=self.a2.reshape(-1), mode='lines', name='Network Approximation',
...
if __name__ == "__main__":
    ...
    with header_cols[1]:
        ...
        st.subheader(' Function Approximation')
        # st.subheader('')
    ...
    with st.sidebar:
        ...
        anim_delay = 20 # Ensure multiples of 10
