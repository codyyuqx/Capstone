...
class SteepestDescentBackprop1():
    ...
    def plot_data(self):
        ...
        #         collection.remove()
        f_data = loadmat("nndbp_new_{}.mat".format(self.pair_of_params))
...
if __name__=="__main__":
    ...
    st.subheader("Stepest Descent Backpropagation #1")
    st.text('')
    st.image("nnd12_1.svg", width=450)
    cols1 = st.columns(3)
    with st.sidebar:
        st.markdown('''
        ...
        ''')
        pair_param = st.selectbox("Select pair of parameters", ['W1(1, 1), W2(1, 1)', 'W1(1, 1), b1(1)', 'b1(1), b1(2)'], 0)
