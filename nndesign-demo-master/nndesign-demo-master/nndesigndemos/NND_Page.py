...
def display_chapters_2_to_5():
    ...
    with col4:
        ...
        create_chapter_demo_selector("Chapter 3",
                                     ['Perception Classification', 'Hamming Classification', 'Hopfield Classification'])
...
def display_chapters_6_to_9():
    ...
    with col4:
        ...
        create_chapter_demo_selector("Chapter 8", [ "Taylor series #1", "Taylor series #2", "Directional derivatives", "Quadratic function"])

        st.markdown('<p class="content-font">Performance Optimization</p>', unsafe_allow_html=True)
        create_chapter_demo_selector("Chapter 9", [ "Steepest descent for Quadratic", "Method comparison", "Newton's method", "Steepest descent"])
...
def display_chapters_10_to_13():
    ...
    with col4:
        ...
        create_chapter_demo_selector("Chapter 10", ["Adaptive noise cancellation", "EEG noise cancellation", "Linear classification"])
        ...
        create_chapter_demo_selector("Chapter 12", [ "Steepest Descent #1", "Steepest Descent #2", "Momentum", "Variable Learning Rate", "CG Line Search", "Conjugate Gradient", "Marquardt Step", "Marquardt"])

        st.markdown('<p class="content-font">Generalizations</p>', unsafe_allow_html=True)
        create_chapter_demo_selector("Chapter 13", [ "Early Stopping", "Regularization", "Bayesian Regularization", "Early Stopping-Regularization"])
...
def display_chapters_14_to_17():
    ...
    with col4:
        ...
        create_chapter_demo_selector("Chapter 14", [ "FIR Network", "IIR Network", "Dynamic Derivatives", "Recurrent Network Training"])

        st.markdown('<p class="content-font">Associative Learning</p>', unsafe_allow_html=True)
        create_chapter_demo_selector("Chapter 15",
                                     [ "Unsupervised Hebb", "Effects of Decay Rate", "Hebb with Decay", "Graphical Instar", "Outstar"])

        st.markdown('<p class="content-font">Competitive Networks</p>', unsafe_allow_html=True)
        create_chapter_demo_selector("Chapter 16", [ "Competitive Classification", "Competitive Learning", "1-D Feature Map", "2-D Feature Map", "LVQ 1", "LVQ 2"])

        st.markdown('<p class="content-font">Radial Basis Function</p>', unsafe_allow_html=True)
        create_chapter_demo_selector("Chapter 17", [ "Network Function Radial", "Pattern Classification", "Linear Least Squares", "Orthogonal Least Squares", "Non Linear Optimization"])
...
def display_chapters_18_to_21():
    ...
    with col4:
        ...
        create_chapter_demo_selector("Chapter 18", [ "Leaky Integrator", "Shunting Network", "Grossberg Layer 1", "Grossberg Layer 2", "Adaptive Weights"])
